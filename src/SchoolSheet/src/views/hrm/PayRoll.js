...
function PayRoll() {
    ...
    useEffect(() => {
        ...
        const netSalary =
            grossSalary -
            grossSalary * (totalTaxPercentage / 100) -
            totalDeductions;
            ...
            <div className='h-screen mt-2'>
                <div className='flex bg-white p-3 justify-between shadow-lg rounded-md'>
                    <div className='flex justify-between w-1/2'>
                        ...
                        <div onClick={openPay}>
                            <Button value={'Create Employee Payslip'} />
                        </div>
                    </div>
                    <div>
                                    ...
                                    <div className='absolute w-1/2 h-[75vh]  overflow-y-auto bg-white shadow-lg rounded-md'>
                                        ...
                                        <div className='flex'>
                                            ...
                                            <div className='w-1/2 p-3'>
                                                    ...
                                                    (deduction, index) => (
                                                        <div>
                                                            ...
                                                            <InputField
                                                                ...
                                                                onChange={(e) =>
                                                                    handleDeductionAmountChangeEdit(
                                                                        e,
                                                                        index
                                                                    )
                                                                }
                                                ...
                                                <br />
                                                <div
                                                    onClick={updateEmployeePay}
                                                >
                                                    <Button
                                                        value={'Update Payslip'}
                                                    />
                                                </div>
                                            </div>
                                        </div>
