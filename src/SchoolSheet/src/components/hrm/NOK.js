...
function NOK() {
	...
	cons[nokType, setNokType] = useState("");
	cons[nokname, setNokName] = useState("");
	cons[nokContact, setNokContact] = useState("");
	...
	return (
		<>
			...
			<div className="flex border-b border-gray1">
				<div className="p-2 w-1/3">Father</div>
                <div className="p-2 w-1/3">Omeny Robert</div>
                <div className="p-2 w-1/3">07898898</div>
			</div>
            <div className="flex border-b border-gray1">
				<div className="p-2 w-1/3">Father</div>
                <div className="p-2 w-1/3">Omeny Robert</div>
