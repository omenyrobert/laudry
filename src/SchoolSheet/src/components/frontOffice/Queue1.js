...
<div className="h-screen mt-1">
				<div className="flex bg-white">
					<div className="w-3/12">
						<div className="p-2 flex">
							<h1 className="text-gray5 font-bold">Waiting</h1>
					...
					<div className="w-3/12">
						<div className="p-2 flex">
							<h1 className="text-gray5 font-bold">Doctor</h1>
							<div className="bg-secondary rounded-full p-1 w-6 text-center ml-2 text-xs font-semibold">
								2
							</div>
						</div>
            ...
            <Card />
					...
					<div className="w-3/12">
						<div className="p-2 flex">
							<h1 className="text-gray5 font-bold">Laboratory</h1>
							<div className="bg-secondary rounded-full p-1 w-6 text-center ml-2 text-xs font-semibold">
								32
							</div>
						</div>
					...
					<div className="w-3/12">
						<div className="p-2 flex">
							<h1 className="text-gray5 font-bold">Pharmacy</h1>
							<div className="bg-secondary rounded-full p-1 w-6 text-center ml-2 text-xs font-semibold">
								12
							</div>
						</div>
            ...
            <Card />
					...
					<div className="w-3/12">
						<div className="p-2 flex">
							<h1 className="text-gray5 font-bold">Finance</h1>
							<div className="bg-secondary rounded-full p-1 w-6 text-center ml-2 text-xs font-semibold">
								12
							</div>
						</div>
