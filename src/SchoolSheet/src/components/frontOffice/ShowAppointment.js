...
function ShowAppointment(props) {
	...
	return (
		<div className="flex justify-center">
			<div className="h-[80vh] overflow-y-auto -mt-[30vh] border border-gray1 shadow-2xl w-[50vw] absolute z-50 bg-white rounded">
				<div className="flex justify-between p-5 bg-gray1">
					<div>
						<p className="text-primary font-semibold">Appointment Details</p>
					</div>
					<div>
