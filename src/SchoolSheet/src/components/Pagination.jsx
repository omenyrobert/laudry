...
const Pagination = ({ setPage, page, count, nextPage, previousPage, canNextPage, canPrevPage, searchPage }) => {
        ...
        <div className="flex text-primary text-sm">
            ...
            </button>
            {
                pages.map((p, i) => {
                    return <button
                        className={
                            `py-1 px-3 border border-gray2 cursor-pointer hover:bg-gray-200`
                        }
                        key={i}
                        onClick={() => {
                            setPage(p);
                        ...
                        style={{
                            ...
                            backgroundColor: page === p ? "rgb(25 50 150 / var(--tw-bg-opacity))" : "inherit",
