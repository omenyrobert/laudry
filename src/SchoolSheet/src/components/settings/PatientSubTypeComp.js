...
function PatientSubTypeComp() {
	...
	return (
		<>
			<h5 className="text-lg font-medium">Patient Sub Types</h5>
			<div className="w-full h-[80vh]">
				<div className="flex justify-between">
					<div className="w-1/3">
						<br />
						<label className="text-gray4">Patient Type</label>
							...
							return (
								...
								>
									...
									<td className="text-xs p-3 text-gray5 flex">
										...
										<BsPencilSquare className="text-warning h-4 w-4 ml-5" 	onClick={() => openEditData(chargetype)} />
									</td>
								</tr>
							);
						})}
...
export default PatientSubTypeComp;
